...
| Topic | Doc |
|---|---|
| All 274 customizations | `docs/handbook/01.1-schema-reference.md` |
| Schema ERD | `docs/handbook/01.2-schema-diagram.md` |
| Shift management workflow | `docs/handbook/02-shift-workflow/*` (Batch 2) |
...
| Disaster recovery procedure | `docs/handbook/04-run-books/*` (Batch 3) |
